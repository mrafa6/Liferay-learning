...
/**
 * Provides the local service interface for Celebrity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CelebrityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CelebrityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CelebrityLocalServiceUtil} to access the celebrity local service. Add custom service methods to <code>com.rafa.service.impl.CelebrityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
